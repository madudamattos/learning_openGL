        ...
        GLdouble upx, GLdouble upy, GLdouble upz)
{
    ...
    // z = up (vetor aproximado para o novo Z)
    z[0] = (float) upx;
    z[1] = (float) upy;
    z[2] = (float) upz;
    ...
    // re-ortogonaliza z = x x y (garante ortogonalidade)
    cross(x, y, z);
    normalize(z);
...
int pontoArmaAponta = 4852;
int pontoPosicaoArma = 2753;
int up[3] = {0, 1, 0};
void desenhaJogador(){
    glMatrixMode(GL_MODELVIEW);
    glPushMatrix();
        ...
        GLdouble upx, GLdouble upy, GLdouble upz)
{
    ...
    // substituicao na matriz m // ela é "normal" pois é a inversa (transposta) da matriz de mover um objeto 
    GLfloat m[4][4] = {
